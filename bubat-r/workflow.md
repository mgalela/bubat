...
- target akhir tetap perlu setara keluaran arsitektur BUBAT:
...
Kalau ingin dipetakan ke tujuan BUBAT:
- discovery intent = Evidence Catalog + Runtime Map
- flows = Behavior Spine
...
Dokumen ini sengaja mendahulukan hard evidence, lalu inferensi, lalu keputusan desain. Itu mekanisme utama untuk mengurangi bias, menghindari rekonstruksi palsu, dan tetap mencapai tujuan arsitektur setara BUBAT untuk case: existing code tanpa dokumentasi sama sekali.