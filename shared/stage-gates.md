...
| G7 Bridge | before `bridge` save | all §C/§V entries trace to extraction map; missing inputs noted explicitly | fill map or mark missing |

## Required Stage Order

`setup → 01-discovery → 01b-flow → 01c-bounded-context → 01d-data-model → 02-context → 03-container → 04-component → 05-document → 06-spec`
